...
`:use system`
* Creating a new database `create database <db_name>`
* `:dbs` Lists all available databases
* `MATCH`

#### CREATING A NODE (Ref 1)
```neo4j
...
### Notes From Neo4j Official Tutorials (Ref 1)
...
## Exploring Movie Database (Ref 2)
The following opens a new window with a browser guide for the movie database
```neo4j
:play movie graph
```
...
## REFERENCES
1. Neo4j Built in tutorials
2. [Neo4j Developer Tutorial](https://neo4j.com/developer/cypher/guide-cypher-basics/)
3. [Neo4j Graph Database Explanation](https://neo4j.com/developer/graph-database/)


## Movie Database Create Statement For Review
```neo4j
