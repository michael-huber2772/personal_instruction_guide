...
| Mean | A type of Average | The average or "expected value.  Add up all of the values and divide by how many there are. Mean and average mean the same thing so the teacher will use them interchangeably | ∑ represents the summation, X represents scores, and N represents the number of scores |
